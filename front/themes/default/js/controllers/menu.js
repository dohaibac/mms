app.controller('MenuListCtrl', function($scope, $http, $location, noty) {
...
app.controller('MenuAddCtrl', function($scope, $http, $location, noty) {
  $scope.processing = false;
...
app.controller('MenuEditCtrl',  function($scope, $routeParams, $http) {
    $scope.processing = false;
