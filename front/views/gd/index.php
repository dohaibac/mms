...
<script type="text/javascript" src="{$app->appConf->theme_default}/js/controllers/gd.js"></script>
<script type="text/javascript" src="{$app->appConf->theme_default}/js/router/gd.js"></script>
