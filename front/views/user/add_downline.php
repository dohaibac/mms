<div class="dashboard-main"  ng-init="init()">
  <div class="col-lg-12 header-title">
    <h1><i class="fa fa-plus"></i> Thêm thành viên downline</h1>
  </div>
  <div>
  <div class="col-md-8">
    {literal}
    <div class="form-group1">
      ...
      <div class="col-md-8">
         <ui-select on-select="onSponsorSelected($item)" ng-model="user.sponsor" theme="bootstrap" style="width:300px;" class="fleft">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
      <input ng-model="user.display_name" ng-trim="true" type="input" name="display_name" class="form-control width300" 
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
      <input ng-model="user.user_name" ng-trim="true"  type="input" name="user_name" class="form-control width300" 
         required ng-maxlength="255">
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-8">
      <input ng-model="user.email" ng-trim="true"  type="input" name="user_name" class="form-control width300" 
         required ng-maxlength="255">
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-8">
      <input ng-model="user.mobile" ng-trim="true"  type="input" name="mobile" class="form-control width300" 
         required ng-maxlength="255">
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-8">
      <input ng-model="user.password" type="password" name="password" class="form-control width300" 
         required ng-maxlength="255">
      </div>
      <div class="clearfix"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-8">
      <input ng-model="user.repassword" type="password" name="repassword" class="form-control width300" 
         required ng-maxlength="255">
      </div>
      <div class="clearfix"></div>
    </div>
