<div class="dashboard-main"  ng-init="init()">
  <div class="col-lg-12 header-title">
    <h1><i class="fa fa-edit"></i> Cập nhật thành viên quản trị downline</h1>
  </div>
  <div>
  <div class="col-md-8">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
      <input ng-model="user.sponsor_owner" readonly="readonly" type="text" name="sponsor_owner" class="form-control" 
        ng-maxlength="255">
      </div>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <a ng-disabled="processing" href="/system#!/user/list_downline" class="btn btn-sm btn-default" type="button"><i class="fa fa-times"></i> Trở về</a>
    </div>
    <div class="clearfix"></div>
    </div>
  </div> <!-- end list-->
