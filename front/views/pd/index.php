...
<script type="text/javascript" src="{$app->appConf->theme_default}/js/controllers/pd.js"></script>
<script type="text/javascript" src="{$app->appConf->theme_default}/js/router/pd.js"></script>
