...
phpFastCache::$config = array(
    "storage"   =>  "memcache", // auto, files, sqlite, apc, cookie, memcache, memcached, predis, redis, wincache, xcache
    "default_chmod" => 0666, // For security, please use 0666 for module and 0644 for cgi.
